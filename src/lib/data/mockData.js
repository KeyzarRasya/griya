...
export const marketingStaff = ['Siti Nurhaliza', 'Dewi Lestari', 'Rina Kusuma', 'Maya Sari', 'Fitri Handayani'];
export const dressColors = ['Putih', 'Putih Gading', 'Putih Broken White', 'Krem', 'Silver', 'Gold'];
export const traditions = ['Jawa', 'Minangkabau', 'Batak', 'Sunda', 'Bali', 'Modern', 'Tidak Ada'];
export const handbouquetColors = ['Pink', 'Violet', 'White', 'Blue'];
export const muaList = ['MUA A', 'MUA B', 'MUA C', 'MUA D'];

export const kainData = [
